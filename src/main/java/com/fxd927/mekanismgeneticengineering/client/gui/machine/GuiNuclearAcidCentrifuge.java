...
public class GuiNuclearAcidCentrifuge extends GuiConfigurableTile<TileEntityNuclearAcidCentrifuge, MekanismTileContainer<TileEntityNuclearAcidCentrifuge>> {
    public GuiNuclearAcidCentrifuge(MekanismTileContainer<TileEntityNuclearAcidCentrifuge> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(() -> tile.firstInputGasTank, () -> tile.getChemicalTanks(null), GaugeType.STANDARD, this, 5, 15))
      ...
      addRenderableWidget(new GuiChemicalGauge(() -> tile.secondInputGasTank, () -> tile.getChemicalTanks(null), GaugeType.STANDARD, this, 28, 15))
