...
public abstract class MGEBaseRecipeCategory<RECIPE> extends AbstractContainerEventHandler implements IRecipeCategory<RECIPE>, IGuiWrapper {
    ...
    protected MGEBaseRecipeCategory(IGuiHelper helper, IRecipeViewerRecipeType<RECIPE> recipeType) {
        this(helper, MGEJEI.recipeType(recipeType), recipeType.getTextComponent(), createIcon(helper, recipeType), recipeType.xOffset(), recipeType.yOffset(), recipeType.width(), recipeType.height());
    }

    protected MGEBaseRecipeCategory(IGuiHelper helper, RecipeType<RECIPE> recipeType, Component component, IDrawable icon, int xOffset, int yOffset, int width, int height) {
    ...
    protected MGEGuiProgress addSimpleProgress(ProgressType type, int x, int y) {
        return addElement(new MGEGuiProgress(getSimpleProgressTimer(), type, this, x, y));
    }

    protected MGEGuiProgress addConstantProgress(ProgressType type, int x, int y) {
        return addElement(new MGEGuiProgress(RecipeViewerUtils.CONSTANT_PROGRESS, type, this, x, y));
    }
