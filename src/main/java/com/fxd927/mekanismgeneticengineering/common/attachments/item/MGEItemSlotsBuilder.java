package com.fxd927.mekanismgeneticengineering.common.attachments.item;
...
public class MGEItemSlotsBuilder {
    ...
    public MGEItemSlotsBuilder addBasicFactorySlots(int process, Predicate<ItemStack> recipeInputPredicate) {
        return addBasicFactorySlots(process, recipeInputPredicate, false);
    }

    public MGEItemSlotsBuilder addBasicFactorySlots(int process, Predicate<ItemStack> recipeInputPredicate, boolean secondaryOutput) {
    ...
    public MGEItemSlotsBuilder addSlots(int count, IBasicContainerCreator<? extends ComponentBackedInventorySlot> creator) {
    ...
    public MGEItemSlotsBuilder addQIODriveSlots(int count) {
        return addSlots(count, QIO_DRIVE_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addQIODashboardSlots() {
    ...
    public MGEItemSlotsBuilder addMinerSlots(int count) {
    ...
    public MGEItemSlotsBuilder addFormulaSlot() {
        return addSlot(FORMULA_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addFormulaCraftingSlot(int count) {
    ...
    public MGEItemSlotsBuilder addLockSlot() {
        return addSlot(SECURITY_LOCK_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addUnlockSlot() {
    ...
    public MGEItemSlotsBuilder addSlot(IBasicContainerCreator<? extends ComponentBackedInventorySlot> slot) {
        slotCreators.add(slot);
        return this;
    }

    public MGEItemSlotsBuilder addFuelSlot() {
        return addSlot(FUEL_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addOredictionificatorInput() {
    ...
    public MGEItemSlotsBuilder addOutput() {
        return addSlot(OUTPUT_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addOutput(int count) {
        return addSlots(count, OUTPUT_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addBasic(int count) {
        return addSlots(count, BASIC_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addInput(int count) {
        return addSlots(count, BASIC_INPUT_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addInput(Predicate<@NotNull ItemStack> isItemValid) {
    ...
    public <VANILLA_INPUT extends RecipeInput, RECIPE extends MekanismRecipe<VANILLA_INPUT>, INPUT_CACHE extends IInputRecipeCache> MGEItemSlotsBuilder addInput(
            IMGERecipeTypeProvider<VANILLA_INPUT, RECIPE, INPUT_CACHE> recipeType, ContainsRecipe<INPUT_CACHE, ItemStack> containsRecipe) {
        return addInput(stack -> containsRecipe.check(recipeType.getInputCache(), null, stack));
    }

    public MGEItemSlotsBuilder addEnergy() {
        return addSlot(FILL_CONVERT_ENERGY_SLOT_CREATOR);
    }

    public MGEItemSlotsBuilder addDrainEnergy() {
    ...
    public MGEItemSlotsBuilder addFluidFillSlot(int tankIndex) {
    ...
    public MGEItemSlotsBuilder addFluidDrainSlot(int tankIndex) {
    ...
    public MGEItemSlotsBuilder addFluidInputSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, ConstantPredicates.manualOnly(), (stack, automationType) -> {
    ...
    public MGEItemSlotsBuilder addFluidRotarySlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex, ConstantPredicates.manualOnly(), (stack, automationType) -> {
    ...
    public MGEItemSlotsBuilder addFluidFuelSlot(int tankIndex, Predicate<@NotNull ItemStack> hasFuelValue) {
    ...
    public MGEItemSlotsBuilder addChemicalFillSlot(int tankIndex) {
    ...
    public MGEItemSlotsBuilder addChemicalFillOrConvertSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
    ...
    public MGEItemSlotsBuilder addChemicalDrainSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
    ...
    public MGEItemSlotsBuilder addChemicalRotaryDrainSlot(int tankIndex) {
    ...
    public MGEItemSlotsBuilder addChemicalRotaryFillSlot(int tankIndex) {
    ...
    public MGEItemSlotsBuilder addInfusionFillOrConvertSlot(int tankIndex) {
        return addSlot(((type, attachedTo, containerIndex) -> new ComponentBackedInventorySlot(attachedTo, containerIndex,
                (stack, automationType) -> automationType == AutomationType.MANUAL || canChemicalFillOrConvertExtract(attachedTo, tankIndex, stack),
                (stack, automationType) -> canChemicalFillOrConvertInsert(attachedTo, tankIndex, stack), ConstantPredicates.alwaysTrue())));
    }
