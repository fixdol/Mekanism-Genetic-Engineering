...
public abstract class MGETileEntityProgressMachine <RECIPE extends MekanismRecipe<?>> extends MGETileEntityRecipeMachine<RECIPE> {
    ...
    protected MGETileEntityProgressMachine(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<CachedRecipe.OperationTracker.RecipeError> errorTypes, int baseTicksRequired) {
