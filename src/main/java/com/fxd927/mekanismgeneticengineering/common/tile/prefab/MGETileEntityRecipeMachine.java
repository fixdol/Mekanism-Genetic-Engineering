package com.fxd927.mekanismgeneticengineering.common.tile.prefab;

import com.fxd927.mekanismgeneticengineering.common.recipe.lookup.IMGERecipeLookupHandler;
import com.fxd927.mekanismgeneticengineering.common.recipe.lookup.monitor.MGERecipeCacheLookupMonitor;
...
public abstract class MGETileEntityRecipeMachine  <RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableMachine implements IMGERecipeLookupHandler<RECIPE> {
    ...
    protected MGERecipeCacheLookupMonitor<RECIPE> recipeCacheLookupMonitor;
    @Nullable
    ...
    protected MGETileEntityRecipeMachine(Holder<Block> blockProvider, BlockPos pos, BlockState state, List<CachedRecipe.OperationTracker.RecipeError> errorTypes) {
    ...
    protected MGERecipeCacheLookupMonitor<RECIPE> createNewCacheMonitor() {
        return new MGERecipeCacheLookupMonitor<>(this);
    }
