...
public interface IMGERecipeLookupHandler<RECIPE extends MekanismRecipe<?>> extends IContentsListener {
    /**
     * @return The world for this {@link IMGERecipeLookupHandler}.
     */
    @Nullable
    Level getLevel();

    /**
     * @return The recipe type this {@link IMGERecipeLookupHandler} handles.
     */
    @NotNull
    IMGERecipeTypeProvider<?, RECIPE, ?> getRecipeType();
    ...
    /**
     * Helper class that specifies the input cache's type for the recipe type. The reason it isn't defined in the main {@link IMGERecipeLookupHandler} is it isn't needed and
     ...
     * purposes.
     */
    interface IMGERecipeTypedLookupHandler<RECIPE extends MekanismRecipe<?>, INPUT_CACHE extends IInputRecipeCache> extends IMGERecipeLookupHandler<RECIPE> {

        @NotNull
        @Override
        IMGERecipeTypeProvider<?, RECIPE, INPUT_CACHE> getRecipeType();
    }
