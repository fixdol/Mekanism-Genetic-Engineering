...
public abstract class MGEEitherSideInputRecipeCache <INPUT, INGREDIENT extends InputIngredient<INPUT>, RECIPE extends MekanismRecipe<?> & BiPredicate<INPUT, INPUT>,
    ...
    protected MGEEitherSideInputRecipeCache(MGERecipeType<?, RECIPE, ?> recipeType, Function<RECIPE, INGREDIENT> inputAExtractor,
