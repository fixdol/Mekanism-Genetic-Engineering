...
public abstract class MGEAbstractInputRecipeCache<RECIPE extends MekanismRecipe<?>> implements IInputRecipeCache {
    protected final MGERecipeType<?, RECIPE, ?> recipeType;
    protected boolean initialized;

    protected MGEAbstractInputRecipeCache(MGERecipeType<?, RECIPE, ?> recipeType) {
     ...
     */
    public <INPUT, INGREDIENT extends InputIngredient<INPUT>, CACHE extends IInputCache<INPUT, INGREDIENT, RECIPE>> boolean containsInput(
