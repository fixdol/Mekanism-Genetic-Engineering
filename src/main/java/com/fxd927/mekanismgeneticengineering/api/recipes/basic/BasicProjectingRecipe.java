...
public class BasicProjectingRecipe extends BasicTriChemicalToChemicalRecipe {
    ...
    public BasicProjectingRecipe(ChemicalStackIngredient firstInput, ChemicalStackIngredient secondInput, ChemicalStackIngredient thirdInput, ChemicalStack output) {
        super(firstInput, secondInput, thirdInput, output, MGERecipeTypes.TYPE_PROJECTING.value());
    }
    ...
    @Override
    public RecipeSerializer<BasicProjectingRecipe> getSerializer() {
